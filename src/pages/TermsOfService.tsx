  ...
  return (
    <>
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <Tabs defaultValue="acceptance" className="w-full mb-12">
          <TabsList className="grid grid-cols-2 md:grid-cols-7 h-auto bg-primary/5 p-1 gap-1">
          ...
          <div className="bg-white rounded-md mt-2 p-6 border shadow-sm">
            <TabsContent value="acceptance" className="mt-0">
              <h2 className="text-xl font-semibold mb-4 flex items-center">
                <ThumbsUp className="mr-2 h-5 w-5 text-blue-600" />
                Acceptance of Terms
              </h2>
            ...
            <TabsContent value="license" className="mt-0">
              ...
              <div className="grid grid-cols-1 gap-2 mb-6">
                {[
                  ...
                  <motion.div 
                    key={i} 
                    className="flex items-center gap-3 p-3 bg-amber-50 border border-amber-100 rounded-md"
                    initial={{ opacity: 0, x: -20 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ delay: i * 0.1 }}
                    viewport={{ once: true }}
                  >
                    <Ban className="h-4 w-4 text-amber-700 flex-shrink-0" />
            ...
            <TabsContent value="disclaimer" className="mt-0">
              ...
              <Card className="border-red-100 mb-6">
                <CardHeader className="pb-2 bg-red-50">
                  <CardTitle className="text-base text-red-800">Important Notice</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <Accordion type="multiple" className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger className="text-sm py-2">Implied Warranties</AccordionTrigger>
                      <AccordionContent>
                    ...
                    <AccordionItem value="item-2">
                      <AccordionTrigger className="text-sm py-2">Accuracy Guarantees</AccordionTrigger>
                      <AccordionContent>
                        <p className="text-sm text-gray-600">
                    ...
                    <AccordionItem value="item-3">
                      <AccordionTrigger className="text-sm py-2">External Links</AccordionTrigger>
                      <AccordionContent>
                        <p className="text-sm text-gray-600">
            ...
            <TabsContent value="limitations" className="mt-0">
              <h2 className="text-xl font-semibold mb-4 flex items-center">
                <Ban className="mr-2 h-5 w-5 text-purple-600" />
                Limitations
              </h2>
              <Separator className="mb-6" />

              <div className="bg-purple-50 border border-purple-100 rounded-md p-5 mb-6">
                <p className="text-gray-700 mb-4">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base">Types of Damages Not Covered</CardTitle>
                </CardHeader>
                <CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <Check className="h-4 w-4 text-emerald-600 mt-0.5" />
                        <span className="text-sm">Safeguard your password and account</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <Check className="h-4 w-4 text-emerald-600 mt-0.5" />
                        <span className="text-sm">Use "strong" passwords for security</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        <Check className="h-4 w-4 text-emerald-600 mt-0.5" />
                        <span className="text-sm">Emails and text messages</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <Check className="h-4 w-4 text-emerald-600 mt-0.5" />
                      ...
                      <li className="flex items-start gap-2">
                        <Check className="h-4 w-4 text-emerald-600 mt-0.5" />
                        <span className="text-sm">Notices and messages on the platform</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="modifications" className="mt-0">
              <h2 className="text-xl font-semibold mb-4 flex items-center">
                <AlarmClock className="mr-2 h-5 w-5 text-pink-600" />
              ...
              <Card className="mb-6">
                <CardHeader className="pb-2 bg-pink-50">
                  <CardTitle className="text-base">Our Rights</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-700 mb-3">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <motion.div 
                        key={i} 
                        className="flex items-start gap-3 p-3 border border-pink-100 rounded-md bg-white"
                        initial={{ opacity: 0, y: 10 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ delay: i * 0.1 }}
                        viewport={{ once: true }}
                      >
                        <AlertTriangle className="h-4 w-4 text-pink-600 flex-shrink-0 mt-0.5" />
            ...
            <TabsContent value="law" className="mt-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-indigo-50 border border-indigo-100 p-4 rounded-md">
                  <h3 className="text-sm font-semibold text-indigo-800 mb-2">Jurisdiction</h3>
                ...
                <div className="bg-indigo-50 border border-indigo-100 p-4 rounded-md">
                  <h3 className="text-sm font-semibold text-indigo-800 mb-2">Severability</h3>
                  <p className="text-xs text-indigo-700">
